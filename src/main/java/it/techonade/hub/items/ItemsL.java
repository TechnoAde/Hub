...
public enum ItemsL {
    PLAYER_HIDED(new ItemBuilder(Material.RED_STAINED_GLASS_PANE,
            1, (short) 0, Main.plugin.getConfig().getString("playerhider.showtitle") != null ? ChatColor.translateAlternateColorCodes('&', Main.plugin.getConfig().getString("playerhider.hidetitle")) : "Null",
            Collections.emptyList()).create()),
    PLAYER_SHOWED(new ItemBuilder(Material.RED_STAINED_GLASS_PANE,
